...
@property (nullable, nonatomic, copy) NSData *kf5_PNGData;    ///< PNG file data
@property (nullable, nonatomic, copy) NSData *kf5_JPEGData;   ///< JPEG file data
@property (nullable, nonatomic, copy) NSData *kf5_GIFData;    ///< GIF file data
@property (nullable, nonatomic, copy) NSData *kf5_WEBPData;   ///< WebP file data
@property (nullable, nonatomic, copy) NSData *kf5_ImageData;  ///< image file data
...
@property (nullable, nonatomic, copy) NSAttributedString *kf5_AttributedString;
