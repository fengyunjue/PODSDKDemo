...
CGAffineTransform YYTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from kf5_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from kf5_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from kf5_convertPoint:before[2] toViewOrWindow:to];
